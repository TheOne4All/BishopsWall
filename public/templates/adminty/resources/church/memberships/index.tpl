                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        <div class="d-inline">
                            ...
                            <span>Manage your organisations Members from this module</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-header p-b-0" id="tabBtn">
                    ...
                    <ul class="nav nav-tabs" id="tabMenu">
                        <li class="nav-item">
                            <a href="#" class="active" data-toggle="tab" role="tab" data-target="#tab_1">Members</a>
                        </li>
                    </ul>
                    <!-- <div class="pull-left">
                        <div class="col-xs-6">
                    ...
                    <div class="pull-right">
                        <div class="col-xs-6">
                            <button class="btn btn-cons tab_1" data-toggle="modal" data-target="#addMember">New
                                Record</button>
                        </div>
                    </div>
                </div>
