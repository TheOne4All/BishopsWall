                    ...
                    <div class="card bg-c-yellow update-card">
                        <div class="card-block">
                            <div class="row align-items-end">
                                <div class="col-8">
                                    <h4 class="text-white">1094</h4>
                                    <h6 class="text-white m-b-0">Total Church Branches</h6>
                                </div>
                        ...
                        <div class="card-block">
                            <div class="row align-items-end">
                                <div class="col-8">
                                    ...
                                    <h6 class="text-white m-b-0">Total Staffs</h6>
                                </div>
                                <div class="col-4 text-right">
                ...
                <div class="col-xl-9 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5>CGMI FaceBook Feed</h5>
<div class="fb-page" data-href="https://www.facebook.com/cgmglobal" data-tabs="timeline" data-width="500" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/cgmglobal"><a href="https://www.facebook.com/cgmglobal">Church of God Mission</a></blockquote></div></div>
                        </div>
                        <div class="card-block">
                        ...
                        <div class="card-block">
                            <div class="row m-b-25">
                                <div class="col-auto p-r-0">
                                    <div class="u-img">
                                        <img src="<?= FYNX_PUBLIC['media_url'] ?>user-profile/f-1.jpg" alt="user image"
                                            class="img-radius cover-img">
                                        <img src="<?= FYNX_PUBLIC['media_url'] ?>user-profile/avatar-2.jpg" alt="user image"
                                                    ...
                                                    <tr>
                                                        <td class="b-none">
                                                            <a href="#!" class="align-middle">
                                                                <img src="<?= FYNX_PUBLIC['media_url'] ?>user-profile/avatar-2.jpg"
                                                                    alt="user image"
                        ...
                        <div class="row m-l-0 m-r-0">
                            <div class="col-sm-4 bg-c-lite-green user-profile">
                                <div class="card-block text-center text-white">
                                    <div class="m-b-25">
                                        <img src="<?= FYNX_PUBLIC['media_url'] ?>user-profile/avatar-4.jpg" class="img-radius"
